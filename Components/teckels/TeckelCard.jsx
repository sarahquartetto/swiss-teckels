...
export default function TeckelCard({ teckel, index = 0 }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-gradient-to-br from-stone-900 to-stone-950 rounded-2xl overflow-hidden border border-amber-900/30 shadow-2xl shadow-black/50">
        {/* Image Container */}
